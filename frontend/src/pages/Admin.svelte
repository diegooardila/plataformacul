    ...
    <div class="flex">
        ...
        >
            ...
            <ul class="space-y-1">
                <li>
                    <button
                        class="w-full text-left px-3 py-2 rounded-lg bg-blue-600 text-white font-medium text-sm shadow"
                        >Gestionar Usuarios</button
                    >
                </li>
                <li>
                    <button
                        class="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-700 text-gray-300 hover:text-white text-sm transition"
                ...
                <form class="p-6 space-y-4" on:submit|preventDefault={saveUser}>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label
                                ...
                                for="id_doc">Documento de Identidad *</label
                            >
                            <input
                                type="text"
                                id="id_doc"
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 mb-1"
                            for="pass"
                            >Contraseña {editingUserId ? "" : "*"}</label
                        >
                        <input
                            type="password"
                            id="pass"
