<script lang="ts">
    ...
    onMount(async () => {
        try {
            ...
            totalCuposOfrecidos = crs.reduce((sum, c) => sum + c.max_capacity, 0);
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-2">Capacidad total: <strong class="text-gray-700">{totalCuposOfrecidos}</strong> cupos general</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between">
                ...
                <div>
                    ...
                    <div class="mt-2 text-sm">
                        <span class="text-gray-500">Curso más popular: </span><span class="font-semibold text-gray-700">{topCursoNombre}</span> <span class="text-xs bg-green-100 text-green-800 px-1.5 rounded">{topCursoInscripciones} matriculados</span>
                    </div>
                </div>
            </div>
        </div>
